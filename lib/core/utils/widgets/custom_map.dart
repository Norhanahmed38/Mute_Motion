...
late CameraPosition initialCameraPosition;
 ...
 void initState(){
   initialCameraPosition= const CameraPosition(
       zoom:12,
       target:LatLng(30.004559689941523, 30.905497794176668));
  initMarkers();
   super.initState();
 ...
 Positioned(
     ...
     child: ElevatedButton(
       ...
       CameraPosition newLocation= const CameraPosition(
           target: LatLng(30.58873908169958, 31.488117497719035),zoom: 12);
...
void initMapStyle() async{
  var roadColor=   await DefaultAssetBundle.of(context).loadString('lib/core/utils/map_style/road_color_gray.json');
