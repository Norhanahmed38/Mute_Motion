...
class _mymapState extends State<mymap> {
  ...
  static const LatLng _destinationlocatio =
      LatLng(30.541920853284697, 31.678156380256656);
  ...
  Future<void> cameratopostion(LatLng pos) async {
    ...
    CameraPosition _newcamerapostion =
        new CameraPosition(target: pos, zoom: 16);
    await controller
